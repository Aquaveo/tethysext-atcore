---
id: controllers.resources.tabs.resource_tab
title: tethysext.atcore.controllers.resources.tabs.resource_tab
sidebar_label: resource_tab
---

# `tethysext.atcore.controllers.resources.tabs.resource_tab`
...
### `ResourceTab(ResourceView)` \{#resourcetab\}
...
##### `get_tabbed_view_context(cls, request, context)` \{#resourcetab-get-tabbed-view-context\}
