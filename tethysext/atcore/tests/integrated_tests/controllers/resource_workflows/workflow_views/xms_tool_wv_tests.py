...
class XmsToolWVTests(WorkflowViewTestCase):
    ...
    def test_arg_mapping(self):
        ...
        self.assertEqual(f'{regex_base_description}:12345678', form.base_fields['bar'].choices[0][1])
        self.assertEqual(f'{mock_dataset2.description}:87654321', form.base_fields['bar'].choices[1][1])
