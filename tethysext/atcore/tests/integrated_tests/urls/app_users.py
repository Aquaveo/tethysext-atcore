...
class AppUserUrlsTests(TethysTestCase):
    ...
    def test_custom_manage_users_controller(self):
        url_maps = app_users.urls(MockUrlMapMaker, custom_controllers=[CustomManageUsers])
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_modify_user_controller(self):
        url_maps = app_users.urls(MockUrlMapMaker, custom_controllers=[CustomModifyUser])
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_add_existing_user_controller(self):
        url_maps = app_users.urls(MockUrlMapMaker, custom_controllers=[CustomAddExistingUser])
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_user_account_controller(self):
        url_maps = app_users.urls(MockUrlMapMaker, custom_controllers=[CustomUserAccount])
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_manage_organizations_controller(self):
        url_maps = app_users.urls(MockUrlMapMaker, custom_controllers=[CustomManageOrganizations])
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_modify_organizations_controller(self):
        url_maps = app_users.urls(MockUrlMapMaker, custom_controllers=[CustomModifyOrganization])
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_manage_organization_members_controller(self):
        url_maps = app_users.urls(MockUrlMapMaker, custom_controllers=[CustomManageOrganizationMembers])
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_models(self):
        ...
        app_users.urls(MockUrlMapMaker, custom_models=[CustomAppUser])
        app_users.urls(MockUrlMapMaker, custom_models=[CustomOrganization])
        app_users.urls(MockUrlMapMaker, custom_models=[CustomResource])
