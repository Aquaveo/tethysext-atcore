...
class ResourceUrlsTests(TethysTestCase):
    ...
    def test_vanilla(self):
        url_maps = resources.urls(MockUrlMapMaker, self.app, None,
    ...
    def test_base_url_path(self):
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, base_url_path=self.base_url_path,
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_base_url_path_startswith_slash(self):
        ...
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, base_url_path=startswith_path,
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
        self.url_asserts(url_maps, with_base_url=True)
    ...
    def test_base_url_path_endswith_slash(self):
        ...
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, base_url_path=endswith_path,
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
        self.url_asserts(url_maps, with_base_url=True)

    def test_custom_manage_resources_controller(self):
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, custom_controllers=[CustomManageResources],
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_modify_resource_controller(self):
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, custom_controllers=[CustomModifyResource],
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_resource_details_controller(self):
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, custom_controllers=[CustomResourceDetails],
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_resource_status_controller(self):
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, custom_controllers=[CustomResourceStatus],
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_invalid_controller_arg_class(self):
        mock_db_name = "foo"
        self.assertRaises(ValueError, resources.urls, MockUrlMapMaker, self.app, mock_db_name,
    ...
    def test_custom_permissions_manager(self):
        url_maps = resources.urls(MockUrlMapMaker, self.app, None, custom_permissions_manager=CustomPermissionsManager,
                                  resource_model=CustomResource)
        self.assertEqual(len(url_maps), self.num_urls)
    ...
    def test_custom_base_url_path_and_models(self):
        ...
        url_maps = resources.urls(
            MockUrlMapMaker, self.app, mock_db_name, base_url_path=self.base_url_path,
    ...
    def test_custom_models(self):
        ...
        mock_db_name = "foo"
        resources.urls(MockUrlMapMaker, self.app, mock_db_name, custom_models=[CustomAppUser],
                       resource_model=CustomResource)
        resources.urls(MockUrlMapMaker, self.app, mock_db_name, custom_models=[CustomOrganization],
                       resource_model=CustomResource)
        self.assertRaises(ValueError, resources.urls, MockUrlMapMaker, self.app, mock_db_name,
    ...
    def test_resource_model(self):
        mock_db_name = "foo"
        resources.urls(MockUrlMapMaker, self.app, mock_db_name, resource_model=CustomResource)
        self.assertRaises(ValueError, resources.urls, MockUrlMapMaker, self.app, mock_db_name,
