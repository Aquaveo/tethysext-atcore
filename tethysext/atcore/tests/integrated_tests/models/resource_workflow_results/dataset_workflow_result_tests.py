...
class DatasetWorkflowResultTests(SqlAlchemyTestCase):
    def setUp(self):
        super().setUp()
        self.instance = DatasetWorkflowResult(name='test')
    ...
    @mock.patch('tethysext.atcore.models.resource_workflow_results.dataset_workflow_result.DatasetWorkflowResult._add_dataset')  # noqa: E501
