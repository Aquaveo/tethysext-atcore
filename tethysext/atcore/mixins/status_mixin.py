...
class StatusMixin(object):
    ...
    OK_STATUSES = [STATUS_AVAILABLE, STATUS_SUCCESS, STATUS_COMPLETE, STATUS_OK, STATUS_CONTINUE,
                   STATUS_APPROVED, STATUS_REVIEWED]
    ...
    COMPLETE_STATUSES = [STATUS_COMPLETE, STATUS_REJECTED, STATUS_APPROVED, STATUS_SUBMITTED, STATUS_OK,
                         STATUS_AVAILABLE, STATUS_SUCCESS, STATUS_REVIEWED]
    HIDDEN_STATUSES = [STATUS_DELETING, STATUS_DELETED, STATUS_HIDDEN, STATUS_ARCHIVED]
    ...
    def valid_statuses(cls):
        return [cls.STATUS_AVAILABLE, cls.STATUS_PENDING, cls.STATUS_DELETING,
                ...
                cls.STATUS_DIRTY, cls.STATUS_REVIEWED, cls.STATUS_ARCHIVED]
